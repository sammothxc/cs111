      ...
      'cases': [
        {
          ...
          >>> a(5)
          5
          >>> (lambda: 3)()  # Using a lambda expression (with no arguments) as an operator in a call exp.
          3
          ...
          >>> c()
          88
          >>> d = lambda f: f(4)  # They can have other functions as arguments as well.
          >>> def square(x):
          ...     return x * x
          >>> d(square)
          16
        ...
        },
        {
          ...
          >>> g = lambda x: x * x
          >>> higher_order_lambda(2)(g) # Are these arguments in the right order?
          Error
